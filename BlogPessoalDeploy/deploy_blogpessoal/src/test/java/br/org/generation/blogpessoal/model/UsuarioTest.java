...
//Nessa classe, estamos verificando se as construções do meu banco de dados estão funcionando corretamente
public class UsuarioTest {
	...
	@Autowired
	private  ValidatorFactory factory = Validation.buildDefaultValidatorFactory();//constroi uma forma de validação
	
	/*é nessa dependencia que vamos verificar se não há nenhuma violação na construção
	...
	void testValidaAtributos() {
		...
		lembrando que, a linha 46 é referente a linha 48 ou seja
	...
	void  testNaoValidaAtributos() {
    	 ...
    	 * pois ele encontrara varios parametros que nao foram construidos corretamente
    	 * isso porque, devemos seguir um processo de construcao do meu banco de dados(referente a minha model Usuario nesse caso)
    	 * logo ele vai salvar na linha 61 varios erros de validacao, isso vai acarretar 
